...
while True:
    ...
    print(
        "     3. Clique no botão com um icone de lupa e escrito 'Visualizar informações do token' do lado direito do programa.")
    ...
    if input(
            "Para gerar o termo, Digite [\033[33mcontinuar\033[m] sem os colchetes.\n\nDigite Aqui: ").lower() == "continuar":
        break

criarTermoRecebimentoToken(nome=nome, cpf=CPF, email=email)
printar.print_amarelo("Finalizando...")
abrir_pasta(caminho_do_arquivo=os.path.join("C:\\", "Users", f"{os.getlogin()}", "Downloads",
                                            "Termo de recebimento de midia.pdf"))
